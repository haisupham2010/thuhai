...
//
        ...
        if (anh_but == "anh1.jpg")
        {
          ...
          cilent_img.setAttribute('src', `./assets/image/anh1.jpg`); 
...
if (anh_but == "anh2.jpg")
{
  ...
  cilent_img.setAttribute('src', `./assets/image/anh2.jpg`); 
...
if (anh_but == "anh3.jpg")
{
  ...
  cilent_img.setAttribute('src', `./assets/image/anh3.jpg`); 
...
//////////////
        ...
        if (anh_but == "anh4.jpg")
          {
            ...
            cilent_img.setAttribute('src', `./assets/image/anh4.jpg`); 
      ...
      if (anh_but == "anh5.jpg")
      {
        ...
        cilent_img.setAttribute('src', `./assets/image/anh5.jpg`); 
      ...
      if (anh_but == "anh6.jpg")
      {
        ...
        cilent_img.setAttribute('src', `./assets/image/anh6.jpg`); 
      ...
      //////////////
          ...
          if (anh_but == "anh7.jpg")
          {
            ...
            cilent_img.setAttribute('src', `./assets/image/anh7.jpg`); 
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Alen Walker") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh1.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Alvie Smith") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh2.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Selena Gomez") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh3.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Ally Jan") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh4.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Dawid Malan") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh5.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
if (motlan == 0) {
    if (cilent_name .innerHTML == "Shelly Ahsan") 
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh6.jpg`; 
      doiten();
      motlan = 1;
    }
  }
...
///
  ...
  if (motlan == 0) {
    if (cilent_name .innerHTML == "rose smith") //anh7
    {
      ...
      //button
      cilentbon.src = `./assets/image/anh7.jpg`; //anh7
      doiten();
      motlan = 1;
    }
  }
